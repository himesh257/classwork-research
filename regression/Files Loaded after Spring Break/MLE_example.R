...
windows(7,7)
#now save the graphs in a pdf file
 pdf(file="C:/users/jmard/Desktop/RegressionMethodsSpring2020/Lecture 11 07APR2020/MLEexampleR_out.pdf")
...
#if p=0.5 then p(S)=P(F) so at .5 likelihood is .5 ^ 10 which = 0.001 ~ 0
check
