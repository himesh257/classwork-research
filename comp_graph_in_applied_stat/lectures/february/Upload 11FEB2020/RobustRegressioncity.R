...
#now save the graphics output into a pdf file
#pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/Output/Robust_city_prices.pdf")
