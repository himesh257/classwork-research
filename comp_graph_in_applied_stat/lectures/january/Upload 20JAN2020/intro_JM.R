...
if (FALSE)
{"
This next syntax directs text output to intro_out.txt.  The output is appended to
existing file. Output is also sent to monitor.
"}

sink("C:/Users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/intro_out.txt",append=FALSE,split=TRUE) 
...
#now save the histogram in a pdf file
pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/intro_out.pdf")
hist(pima$diastolic,xlab="Diastolic",main="")
#  use either dev.off () - dev.off shuts down the specified (by default the current) device
#  or graphics.off( ) - closes pdf file and returns output to graphics window of console
dev.off ()
...
pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/ggplot_example.pdf")
...
graphics.off( )  #closes the pdf file
