...
# https://flowingdata.com/2020/03/18/how-to-flatten-the-curve-a-social-distancing-simulation/

# install.packages(c("EpiModel", "extrafont", "animation"), 
#                  dependencies = TRUE)
...
# Plot it.
 par(family="Consolas", cex.axis=.9, las=1)
