...
#now save the ecdf in a pdf file
 pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/Lecture 07 11Feb2020/permutation2R_out.pdf")
...
spear_hat <- cor(x=SAT, y=GPA, method = 'spearman') #Spearman Rank Correlation Coefficient
spear_hat
