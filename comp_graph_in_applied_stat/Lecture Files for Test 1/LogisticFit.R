#Measures of fit for a Logistic regression
...
#now save the ecdf in a pdf file
 pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/Lecture 08 14Feb2020/LogisticFitR_out.pdf")
