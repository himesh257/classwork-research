#Challenger O-ring Logistic regression
       
windows(7,7)
#now save the ecdf in a pdf file
 pdf(file="C:/users/jmard/Desktop/Computing and Graphics in Applied Statistics2020/Lecture 08 14Feb2020/ChallengerR_out.pdf")
